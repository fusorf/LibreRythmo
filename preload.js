...
contextBridge.exposeInMainWorld('api', {
  ...
  saveProject: (json, p, suggested) => ipcRenderer.invoke('save-project', json, p, suggested),
  ...
  ytDefaultDir: () => ipcRenderer.invoke('yt-default-dir'),
  ytProbe: (url) => ipcRenderer.invoke('yt-probe', url),
  ytDownload: (opts) => ipcRenderer.invoke('yt-download', opts),
  ytCancel: () => ipcRenderer.invoke('yt-cancel'),
  ytTrim: (opts) => ipcRenderer.invoke('yt-trim', opts),
  onYtProgress: (cb) => ipcRenderer.on('yt-progress', (e, p) => cb(p)),
  takesExportPick: (suggested) => ipcRenderer.invoke('takes-export-pick', suggested),
  exportTakes: (opts) => ipcRenderer.invoke('export-takes', opts),
  onTakesProgress: (cb) => ipcRenderer.on('takes-export-progress', (e, p) => cb(p)),
  detachedOpen: () => ipcRenderer.invoke('detached-open'),
  detachedSend: (p) => ipcRenderer.invoke('detached-send', p),
  detachedReadySignal: () => ipcRenderer.invoke('detached-ready'),
  detachedToggleFullscreen: () => ipcRenderer.invoke('detached-fullscreen'),
  onDetachedMsg: (cb) => ipcRenderer.on('detached-msg', (e, p) => cb(p)),
  onDetachedReady: (cb) => ipcRenderer.on('detached-ready', () => cb()),
  onDetachedClosed: (cb) => ipcRenderer.on('detached-closed', () => cb()),
