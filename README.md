...
- **Voice removal (AI)** — remove the voices from an audio track (produces an instrumental added as a new track) with a light local engine (MDX-Net ONNX). Optional, installed on demand — nothing bundled.
